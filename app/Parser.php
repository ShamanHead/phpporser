...
class Dom
{
     ...
     * Dom constructor.
     * @param $url
     * @param bool $enable_comments
     * @param bool $enable_styles_scripts
     * @param bool $headers
     */
                        ...
                        if ($stack[$i]['tag'] == $ommited_tags_list[$x][2][$c]) {
                            ...
                            for ($j = $i + 1; $j < count($stack); $j++) {
                                for ($z = 0; $z < count($ommited_tags_list[$x][1]); $z++) {
                                    ...
                                    if (strcasecmp($stack[$j]['tag'], $ommited_tags_list[$x][1][$z]) == 0 && $stack[$j]['is_closing'] && $first_time) {
                                        $first_time = false;
                                    } else if (strcasecmp($stack[$j]['tag'], $ommited_tags_list[$x][1][$z]) == 0 && $stack[$j]['is_closing'] && !$first_time) {
                    ...
                    if (strcasecmp($stack[$i]['tag'], $ommited_tags_list[$k][0]) == 0) {
                        ...
                        for ($j = $i; $j < $i + 100; $j++) {
                            ...
                            for ($z = 0; $z < count($ommited_tags_list[$k][1]); $z++) {
                                if (strcasecmp($stack[$j]['tag'], $ommited_tags_list[$k][1][$z]) == 0 && $stack[$j]['is_closing']) {
                                    $first_time = false;
                                }
